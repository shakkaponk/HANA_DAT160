		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Interaction Items List",
									"targetURL": "#InteractionItemsList-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"InteractionItemsList-display": {
								"semanticObject": "InteractionItemsList",
								"action": "display",
								"description": "Interaction Items List : Find your items",
								"title": "Interaction Items List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=interactionitems",
									"url": sap.ui.require.toUrl("interactionitems")
								}
							}
						}
					}
